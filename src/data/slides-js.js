const slides = [{
    ...
    },
    {
        ...
        subtitle: "... i jak w przypadku każdego skomplikowanego problemu nie obędzie się bez frustracji. Jednak daje też sporo satysfakcji.",
    ...
    },
    {
        ...
        subtitle: "Język skryptowy używany do obsługi strony w przeglądarce (front end) i po stronie serwerów (back end) na platformie Node.",
        list: [
    ...
    },
    {
        ...
        text: "Zmienne i stałe deklarujemy używając var, let. Stałe deklarujemy słowem const przed nazwą zmiennej. Potem możemy przypisać jej wartośc. ",
        commentedcode: [{
                comment: "Zmienna var - używana we wcześniejszych wersjach JS. Warto jej unikać.",
                code: ["var a = -10;"]
            },
            {
                comment: "Zmienna let.",
    ...
    },
    {
        ...
        subtitle: "Zmienne to coś w rodzaju 'pudełek', w których pod nazwami możemy trzymać dane.",
        text: "W JS używamy 5-ciu podstawowych typów danych. Dzielą się na typy proste(numer, ciąg znaków, wartość logiczna, null i undefined,) i typy złożone. Możemy sprawdzić typ wywołując funkcję typeof",
        commentedcode: [
    ...
    },
    {
        ...
        subtitle: "Wszystkie zmienne nie będące typem prostym są obiektami i są typu referencyjnego.",
        text: "Ten typ danych charakteryzuje się tym, że zmienne nie mają przypisanej bezpośrednio wartości, a tylko wskazują na miejsce w pamięci, gdzie te dane są przetrzymywane.",
        commentedcode: [{
                comment: "Tablica",
    ...
    },
    {
        ...
        text: "Bywa przydatne przy budowaniu treści na stronę, choć może powodować błędy w bardziej skompilowanych skryptach.",
        code: [
    ...
    {
        title: "Zadanie",
        subtitle: "Stwórz dokument folder z podstawową stroną HTML, i podlinkuj ją do pliku script.js. Spróbuj zgadnąć wyniki poniższych działań.",
    ...
    },
    {
        ...
        subtitle: "Operatory logiczne stosuje się w instrukcjach warunkowych. Służą one do porównywania lewej strony równania do prawej. let x = 5;",
        commentedcode: [{
                comment: "== - porównanie czy dwie wartości są równe, mogą być różne typy",
    ...
    },
    {
        ...
        subtitle: " pomocą operatorów logicznych możemy łączyć kilka porównań w jedną całość. Poniżej przykłady dla x = 6 i y = 3:",
        commentedcode: [{
    ...
    },
    {
        ...
        subtitle: "Wartości które nie są ani true ani false ale zwracają true lub false",
    ...
    {
        title: "Zadanie",
        subtitle: "Spróbuj zgadnąć wyniki poniższych działań. const a = 8; const b = 15;",
        list: [
            "a === 8 && b === 10",
            "a === 8 || b === 8",
            "a === 8 ^ b === 15",
    ...
    },
    {
        ...
        subtitle: "Javascript zezwala nam na stosowanie instrukcji warunkowych, które sterują przebiegiem naszego programu.",
        text: "Instrukcja warunkowa wykonuje wybrany kod, w zależności czy wartość danego wyrażenia jest prawdą czy nie. if, else if, else - if sprawdza dany warunek, i w zależności czy jest on równy true lub false wykona sekcję kodu zawartą w klamrach",
        code: [
            "const x = 5;",
            "if (x > 5) {...} ",
            "else if (x < 5) {...} ",
    ...
    },
    {
        title: "Instrukcje warunkowe - Switch",
        commentedcode: [{
            comment: "Każdy przypadek kończymy słowem break. Jeżeli pominiemy break, wtedy nawet przy pomyślnym przyrównaniu zostaną wykonane kolejne sprawdzenia.",
            code: [
                "const num = 2;",
                "switch (num) {",
                "    case 1:",
    ...
    {
        title: "Zadanie",
        subtitle: "W folderze zadanie_warunki znajdziesz pliki html i JS z poniższym kodem",
        list: [
    ...
    {
        title: "Pętle - while",
        subtitle: "W pętli tego typu nie definiujemy pierw licznika, ani zmiany licznika.",
    ...
    },
    {
        ...
        subtitle: "Bardzo często używamy obiektów i tablic do przechowywania danych. Dzięki użyciu pętli możemy budować z nich treści strony.",
        code: [
    ...
    },
    {
        ...
        subtitle: "Większość danych przesyłanych między backendem a frontendem używa formatu typu JSON(lub podobnych).",
    ...
    {
        title: "Zadanie",
        subtitle: "Gwiezdne wojny to nie jest jakiś rewelacyjny film do tego ćwiczenia da radę",
        text: "* - dodatkowe punkty",
        list: [
            "W folderze zadanie_sw znajdziesz pliki html i pliki postacie.js i script.js w pliku script.js",
    ...
    {
        title: "Funkcje",
        subtitle: "Pozwalają na rozbicie kodu na mniejsze kawałki spełniające określone ... funkcje.",
        text: "Pozwala nam na wywołanie danej funkcjonalności w dowolnym obszarze kodu.",
        commentedcode: [{
    ...
    },
    {
        ...
        subtitle: "Czasem konieczne będzie przekazanie do funkcji danych, które następnie zostaną przez nią przetworzone.",
        commentedcode: [{
                comment: "Deklaracja funkcji",
                code: [
    ...
    },
    {
        ...
        subtitle: "Często funkcja ma zwrócić wynik czegoś. Wtedy używamy zwrotu return.",
        text: "return nie dość, że zwraca jakieś dane to również kończy wykonanie tej funkcji",
        commentedcode: [{
    ...
    },
    {
        ...
        subtitle: "W ES6 zostały wprowadzone funkcje strzałkowe, ktróre można umieścić w jednej linii",
